...
void dw9784_post_firmware_download(void)
{
	...
	ret = ois_i2c_rd_u16(m_client, 0x7194, &is_gyro);
	LOG_INF("dw9784_post_firmware_download ois_reset is_gyro: 0x%x\n", is_gyro);
	return;
}
...
static int dw9784_init(struct dw9784_device *dw9784)
{
	...
	//ois_reset();
	//ret = ois_i2c_wr_u16(m_client, 0x7020, 0x0000);
...
static int dw9784_power_on(struct dw9784_device *dw9784)
{
	...
	LOG_INF("dw9784 dw9784 init success");
	return 0;
...
static long dw9784_ops_core_ioctl(struct v4l2_subdev *sd, unsigned int cmd, void *arg)
{
	...
	ret = ois_i2c_rd_u16(client, 0x7110, &spi_dara_a);
	LOG_INF("get spi_dara_a 0x%x\n",spi_dara_a);
	ret = ois_i2c_rd_u16(client, 0x7140, &spi_dara_b);
	LOG_INF("get spi_dara_b 0x%x\n",spi_dara_b);

	ret = ois_i2c_rd_u16(client, 0x7101, &ois_dara_a);
	LOG_INF("get ois_dara_a 0x%x\n",ois_dara_a);
