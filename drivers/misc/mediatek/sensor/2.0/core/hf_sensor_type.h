...
enum {
	...
	SENSOR_TYPE_ACCELEROMETER_FLIP = 144,
	SENSOR_TYPE_GYROSCOPE_FLIP = 145,
	SENSOR_TYPE_PS_APPROACH = 146,
	SENSOR_TYPE_PROXCAL =  147,
	SENSOR_TYPE_PROX_CLI =  148,
	SENSOR_TYPE_MOT_PICK_UP_GESTURE = 149,
	SENSOR_TYPE_VSYNC =  150,
