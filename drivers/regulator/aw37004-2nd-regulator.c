...
static int aw37004_2nd_debug = 0;
module_param(aw37004_2nd_debug,int, 0644);

enum aw37004_2nd_regulators {
	...
	*/
	...
	if (ret < 0) {
		...
		case WL28661D_CHIP_ID:
			dev_info(chip->dev, "WL28661D_2ND CHIP ID matched!\n");
			is_aw37004 = FALSE;
			break;
		default:
			dev_err(dev,
...
MODULE_DESCRIPTION("AW37004_2ND regulator driver");
MODULE_LICENSE("GPL");
