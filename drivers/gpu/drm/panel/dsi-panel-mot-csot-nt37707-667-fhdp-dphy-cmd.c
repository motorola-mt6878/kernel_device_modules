...
static void lcm_panel_init(struct lcm *ctx)
{
	if (ctx->version != 1) {
		...
		lcm_dcs_write_seq_static(ctx, 0xEC, 0x02, 0x28, 0x02, 0x28, 0x02, 0x13, 0x02, 0x13, 0x02, 0x00, 0x02, 0x00, 0x02, 0x9D, 0x02, 0x9D, 0x02, 0xF0, 0x02, 0xF0, 0x02, 0xE8, 0x02, 0xE8, 0x02, 0x00, 0x02, 0x00);
		lcm_dcs_write_seq_static(ctx, 0x6F, 0x43);
		lcm_dcs_write_seq_static(ctx, 0xEC, 0x02, 0x60, 0x02, 0x60, 0x02, 0x70, 0x02, 0x70, 0x02, 0x50, 0x02, 0x50, 0x02, 0x5B, 0x02, 0x5B, 0x02, 0xD0);
		lcm_dcs_write_seq_static(ctx, 0x6F, 0x55);
		lcm_dcs_write_seq_static(ctx, 0xEC, 0x02, 0x28, 0x02, 0x28, 0x02, 0x13, 0x02, 0x13, 0x02, 0x00, 0x02, 0x00, 0x02, 0x9D, 0x02, 0x9D, 0x02, 0xF0, 0x02, 0xF0, 0x02, 0xE8, 0x02, 0xE8, 0x02, 0x00, 0x02, 0x00);
		lcm_dcs_write_seq_static(ctx, 0x6F, 0x71);
		lcm_dcs_write_seq_static(ctx, 0xEC, 0x02, 0x60, 0x02, 0x60, 0x02, 0x70, 0x02, 0x70, 0x02, 0x50, 0x02, 0x50, 0x02, 0x5B, 0x02, 0x5B, 0x02, 0xD0);
	}
	...
	if (ctx->version == 1) {
		//optimizate the effect of enter and exit DC,EVT2 will OTP it.
		lcm_dcs_write_seq_static(ctx, 0xF0, 0x55, 0xAA, 0x52, 0x08, 0x00);
		lcm_dcs_write_seq_static(ctx, 0x6F, 0x2B);
		lcm_dcs_write_seq_static(ctx, 0xB2, 0x00, 0x00, 0x0D, 0xA3, 0x11, 0xD0, 0x19, 0x9B, 0x1D, 0x99, 0x26, 0xD7, 0x35, 0x39, 0x3F, 0xF2, 0x3F, 0xFF, 0x3F, 0xFF);
		//optimizate the effect of enter and exit DC Demura gain,EVT2 will OTP it.
		lcm_dcs_write_seq_static(ctx, 0xF0, 0x55, 0xAA, 0x52, 0x08, 0x00);
		lcm_dcs_write_seq_static(ctx, 0x6F, 0x31);
		lcm_dcs_write_seq_static(ctx, 0xC0, 0x12, 0x34, 0x06, 0x78, 0x90);
		//add the commad to reduce the frequency. optimizate the issue with ALT,DVT1 will otp it
		lcm_dcs_write_seq_static(ctx, 0xF0, 0x55, 0xAA, 0x52, 0x08, 0x00);
		...
		//update Demura setting 927, DVT1 will dete it .
		lcm_dcs_write_seq_static(ctx, 0x6F, 0x5A);
		lcm_dcs_write_seq_static(ctx, 0xD1, 0x22, 0x22, 0x42, 0x44);
		//optimizate the effect of low frequency, DVT1 will dete it .
		lcm_dcs_write_seq_static(ctx, 0xF0, 0x55, 0xAA, 0x52, 0x08, 0x03);
		lcm_dcs_write_seq_static(ctx, 0x6F, 0x03);
		lcm_dcs_write_seq_static(ctx, 0xC3, 0x02);
	...
	lcm_dcs_write_seq_static(ctx, 0xBA, 0x01, 0x01, 0x02, 0x01, 0x01, 0x01, 0x01, 0x00, 0x01, 0x01, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00);
	lcm_dcs_write_seq_static(ctx, 0x6F, 0x2C);
	lcm_dcs_write_seq_static(ctx, 0xBA, 0x00, 0x01, 0x00, 0x01, 0x00, 0x03, 0x00, 0x01, 0x01, 0x01, 0x01, 0x01, 0x00, 0x00, 0x00, 0x00);
	...
	lcm_dcs_write_seq_static(ctx, 0xBA, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00);
	...
	lcm_dcs_write_seq_static(ctx, 0xBA, 0x02, 0x03, 0x02, 0x01, 0x00, 0x03, 0x00, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00);
	...
	lcm_dcs_write_seq_static(ctx, 0xBB, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00);
	...
	if (ctx->version == 1) {
		...
		lcm_dcs_write_seq_static(ctx, 0xBE, 0x13);

		lcm_dcs_write_seq_static(ctx, 0xF0, 0x55, 0xAA, 0x52, 0x08, 0x00);
		//EMEISION_DBV_TH (DBV=52Ah,59.9nit)  //14bit
		lcm_dcs_write_seq_static(ctx, 0x6F, 0x1C);
		lcm_dcs_write_seq_static(ctx, 0xB2, 0x14, 0xAB, 0x3F, 0xFF);
		lcm_dcs_write_seq_static(ctx, 0x6F, 0xD1);
		lcm_dcs_write_seq_static(ctx, 0xB2, 0x14, 0xAB);

		lcm_dcs_write_seq_static(ctx, 0xF0, 0x55, 0xAA, 0x52, 0x08, 0x00);
		lcm_dcs_write_seq_static(ctx, 0xB2, 0x09, 0x60);

		//DBV_TH
		lcm_dcs_write_seq_static(ctx, 0xB3, 0x00, 0x04, 0x04, 0x0C, 0x04, 0x0C, 0x07, 0x60, 0x07, 0x60, 0x08, 0xE0, 0x08, 0xE0, 0x0C, 0x28, 0x0C, 0x28, 0x11, 0x10, 0x11, 0x10, 0x14, 0xAB, 0x14, 0xAB);
		lcm_dcs_write_seq_static(ctx, 0x6F, 0x1A);
		lcm_dcs_write_seq_static(ctx, 0xB3, 0x14, 0xAC, 0x14, 0xAC, 0x1A, 0x3C, 0x1A, 0x3C, 0x24, 0x20, 0x24, 0x20, 0x36, 0xE8, 0x36, 0xE8, 0x3F, 0xFC);

		lcm_dcs_write_seq_static(ctx, 0xF0, 0x55, 0xAA, 0x52, 0x08, 0x00);
		//REMAP_DBV_ST = 0, REMAP_DBV_ED =52B, REMAP_GMA_BAND_SEL = 7
		lcm_dcs_write_seq_static(ctx, 0x6F, 0xDF);
		lcm_dcs_write_seq_static(ctx, 0xB2, 0x00, 0x00, 0x14, 0xAC, 0x07);
		//Set1_REMAP_DBV_TH_00~Set1_REMAP_DBV_TH_09
		lcm_dcs_write_seq_static(ctx, 0x6F, 0x34);
		lcm_dcs_write_seq_static(ctx, 0xB3, 0x00, 0x04, 0x04, 0x0C, 0x07, 0x60, 0x08, 0xE0, 0x0C, 0x28, 0x11, 0x10, 0x14, 0xAB, 0x14, 0xAC, 0x1A, 0x3C, 0x24, 0x20);
		//Set1_REMAP_DBV_TH_10~Set1_REMAP_DBV_TH_19
		lcm_dcs_write_seq_static(ctx, 0x6F, 0x48);
		lcm_dcs_write_seq_static(ctx, 0xB3, 0x36, 0xE8, 0x3F, 0xFC, 0x3F, 0xFC, 0x3F, 0xFC, 0x3F, 0xFC, 0x3F, 0xFC, 0x3F, 0xFC, 0x3F, 0xFC, 0x3F, 0xFC, 0x3F, 0xFC);
		//Set1_REMAP_DBV_TH_20~Set1_REMAP_DBV_TH_29
		lcm_dcs_write_seq_static(ctx, 0x6F, 0x5C);
		lcm_dcs_write_seq_static(ctx, 0xB3, 0x3F, 0xFC, 0x3F, 0xFC, 0x3F, 0xFC, 0x3F, 0xFC, 0x3F, 0xFC, 0x3F, 0xFC, 0x3F, 0xFC, 0x3F, 0xFC, 0x3F, 0xFC, 0x3F, 0xFC);
		//Set1_REMAP_DBV_TH_30~Set1_REMAP_DBV_TH_33
		lcm_dcs_write_seq_static(ctx, 0x6F, 0x70);
		lcm_dcs_write_seq_static(ctx, 0xB3, 0x3F, 0xFC, 0x3F, 0xFC, 0x3F, 0xFC, 0x3F, 0xFC);
		//trigger cmd
		lcm_dcs_write_seq_static(ctx, 0xF0, 0x55, 0xAA, 0x52, 0x08, 0x00);
		lcm_dcs_write_seq_static(ctx, 0x6F, 0xE7);
...
static struct mipi_dsi_driver lcm_driver = {
	...
	.remove = lcm_remove,
	.driver = {
		.name = "csot_nt37707_667_1080_2640",
		.owner = THIS_MODULE,
