...
static void lcm_panel_init(struct lcm *ctx)
{
	...
	*/
	...
	lcm_dcs_write_seq_static(ctx, 0xb1,0x01,0x9B,0x00,0x18,0x00,0x34,0x00);
	lcm_dcs_write_seq_static(ctx, 0x65,0x07);
	lcm_dcs_write_seq_static(ctx, 0xb1,0x01,0x9B,0x00,0x18,0x03,0xC4,0x00);
	lcm_dcs_write_seq_static(ctx, 0x65,0x0e);
	lcm_dcs_write_seq_static(ctx, 0xb1,0x01,0x9B,0x00,0x18,0x0B,0x00,0x00);
	lcm_dcs_write_seq_static(ctx, 0x65,0x15);
	lcm_dcs_write_seq_static(ctx, 0xb1,0x01,0x9B,0x00,0x18,0x10,0x68,0x00);
	lcm_dcs_write_seq_static(ctx, 0xb2,0x01,0x9B,0x00,0x18,0x00,0x34,0x03);
	lcm_dcs_write_seq_static(ctx, 0x65,0x07);
	lcm_dcs_write_seq_static(ctx, 0xb2,0x01,0x9B,0x00,0x18,0x00,0x34,0x03);
	lcm_dcs_write_seq_static(ctx, 0x65,0x0e);
	lcm_dcs_write_seq_static(ctx, 0xb2,0x01,0x9B,0x00,0x18,0x00,0x34,0x03);
	...
	lcm_dcs_write_seq_static(ctx, 0xf3,0x49);
